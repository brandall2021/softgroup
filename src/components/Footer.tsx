          ...
          <AnimateOnScroll animation="fadeUp" delay={0.3}>
            ...
            <ul className="mt-5 flex flex-col gap-4">
              <li className="flex items-start gap-3 text-sm text-slate-400">
                ...
                <span>Av. Tecnológica 1250, Ciudad de México, CDMX</span>
              </li>
              <li className="flex items-start gap-3 text-sm text-slate-400">
            ...
            <div className="mt-8">
              ...
              <form onSubmit={handleNewsletter} className="mt-3 flex gap-2">
                ...
                <input
                  ...
                  required
                  className="flex-1 rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white placeholder-slate-500 outline-none transition-all focus:border-brand/50 focus:ring-1 focus:ring-brand/50"
                />
                <button
                  type="submit"
